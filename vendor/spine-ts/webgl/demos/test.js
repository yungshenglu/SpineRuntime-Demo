var transitionsDemo = function(canvas, loadingComplete, bgColor) {
	...
	function init () {
		...
		assetManager.loadTexture(DEMO_NAME, textureLoader, "origin.png");
		assetManager.loadText(DEMO_NAME, "origin.atlas");
		assetManager.loadJson(DEMO_NAME, "origin.json");
	...
	function loadSkeleton(name) {
		var atlas = new spine.TextureAtlas(assetManager.get(DEMO_NAME, "origin.atlas"), function(path) {
			return assetManager.get(DEMO_NAME, path);
		});
		var atlasLoader = new spine.AtlasAttachmentLoader(atlas);
		var skeletonJson = new spine.SkeletonJson(atlasLoader);
		var skeletonData = skeletonJson.readSkeletonData(assetManager.get(DEMO_NAME, "origin.json")[name]);
